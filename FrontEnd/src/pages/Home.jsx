...
function Home() {
  ...
  </tr>
 {
  products.map(product=>(
    ...
    <td style={{width:"10px"}}> <Link  to={`/${product._id}`}><button style={{border:"none",backgroundColor:"blue",color:"white",margin:"0 20px"}}>Detail</button></Link>
...
<Link to="add" >
<button style={{border:"none",backgroundColor:"green",borderRadius:"5px",width:"100px",marginTop:"30px",color:"white",height:"30px"}}>Add</button></Link>
